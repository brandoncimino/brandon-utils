...
namespace BrandonUtils.Standalone.Strings.Prettifiers {
    internal static partial class InnerPretty {
        ...
        [NotNull, Pure]
        public static string Tuple8Plus<T, T2, T3, T4, T5, T6, T7, T8>((T, T2, T3, T4, T5, T6, T7, T8) tuple, [CanBeNull] PrettificationSettings settings = default) => tuple.ToArray().PrettifyTupleArray(settings);
    }
}